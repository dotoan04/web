...
export default async function PostDetailPage({ params }: Props) {
  ...
  return (
    <article className="mx-auto w-full max-w-6xl px-6 py-12">
      ...
      >
        <div
          className="prose prose-lg prose-ink mx-auto w-full text-ink-800 dark:text-ink-100 dark:prose-invert dark:prose-ink-dark"
          dangerouslySetInnerHTML={{ __html: html }}
        />
        {hasHeadings ? (
          <div className="sticky top-20 xl:mx-auto xl:w-full xl:max-w-sm">
