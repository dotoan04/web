...
export const Header = () => {
  return (
    <header className="relative z-[70] flex items-center justify-between rounded-full border border-ink-100 bg-white/80 px-6 py-4 shadow-[0_12px_35px_rgba(27,20,14,0.08)] backdrop-blur-xl dark:border-ink-700 dark:bg-ink-800/70">
